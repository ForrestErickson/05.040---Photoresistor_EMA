...
/*Slow down ADC  Makes the measurement top out at 4095 when set to large values. 
 * When set at 1 the ADC does not max out and has ripple under floresent lighting.
 * When set at 255 the ADC will max out.
 */
//  analogSetClockDiv(254);   
